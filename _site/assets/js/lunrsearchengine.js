...
var documents = [{
    ...
    "title": "ABOUT ME",
    "body": "   Collaborating with leaders to solve their customer's most challenging problems on Azure.   HIGHLIGHTS:   6 Years of Experience in IT      4 years in software development   2 years as team leader and cloud engineer   Strong problem solving/analytical skills   Strong technical skills in Java, Azure Devops, Application modernization and data service   Have ability to learn new technology quickly and efficiently    TECHNICAL SKILLS:   Cloud      Azure (Azure Devops, App modernization, Azure Sentinel, AKS, AVD)   AWS (VPC, API Gateway, EC2, S3, Lambda, ECS, IAM, Cognito, CloudWatch)    Programming/Scripting      Java, GoLang, Android, iOS   JavaScript, HTML, CSS   Spring, VueJS, NuxtJS   Shell Script, Batch Script    Framework/Tools      Build management: Maven, Ant   Version control system: SVN, Git, VSTS   Task management: Redmine, Jira, Trello    OS &amp; Networking      OS: CentOS, Windows, Ubuntu, Redhat, macOS   Server: Apache, Tomcat, Nginx   Database: MySQL, PostgreSQL, MongoDB   Security: SSL/TLS, XSS, SQL injection   Protocol: SMTP, POP3, SMIME, DKIM, FTP   Contact meFeel free to contact me, if have any question.  Phone: (+84)389304752  Github: dattran-github  Email: dattran-email  Facebook: dattran-facebook "
    }, {
    "id": 2,
    ...
    "title": "Home",
    "body": "{% if page. url == “/” %}       Events:       {% for post in site. posts %}    {% if post. featured == true %}      {% include featuredbox. html %}    {% endif %}  {% endfor %}  {% endif %}       All Posts:         {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}    {% include pagination. html %}"
    }, {
    "id": 7,
